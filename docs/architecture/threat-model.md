...
- Keep provider routes fixed in reviewed code, disable redirects, scope authorization headers exactly, strictly decode bounded provider streams, and never retry dispatched inference automatically.

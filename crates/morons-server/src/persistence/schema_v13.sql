...
CREATE TABLE tool_calls_v13 (
    ...
    tool_kind INTEGER NOT NULL CHECK (tool_kind BETWEEN 1 AND 11),
...
CREATE TABLE tool_audit_facts_v13 (
    ...
    tool_kind INTEGER CHECK (tool_kind IS NULL OR tool_kind BETWEEN 1 AND 11),
...
INSERT INTO tool_audit_facts_v13 SELECT * FROM tool_audit_facts;
DROP TABLE tool_audit_facts;
ALTER TABLE tool_audit_facts_v13 RENAME TO tool_audit_facts;

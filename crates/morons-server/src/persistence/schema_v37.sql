BEGIN IMMEDIATE;
CREATE TABLE web_search_attempts_v37 (
...
INSERT INTO web_search_attempts_v37 SELECT * FROM web_search_attempts;
DROP TABLE web_search_attempts;
ALTER TABLE web_search_attempts_v37 RENAME TO web_search_attempts;

...
CREATE TABLE tool_calls_v15 (
    ...
    tool_kind INTEGER NOT NULL CHECK (tool_kind BETWEEN 1 AND 12),
...
INSERT INTO tool_calls_v15 SELECT * FROM tool_calls;
DROP TABLE tool_calls;
ALTER TABLE tool_calls_v15 RENAME TO tool_calls;
CREATE INDEX tool_calls_by_run ON tool_calls (run_id, fact_sequence);

CREATE TABLE tool_audit_facts_v15 (
    ...
    tool_kind INTEGER CHECK (tool_kind IS NULL OR tool_kind BETWEEN 1 AND 12),
...
INSERT INTO tool_audit_facts_v15 SELECT * FROM tool_audit_facts;
DROP TABLE tool_audit_facts;
ALTER TABLE tool_audit_facts_v15 RENAME TO tool_audit_facts;

...
CREATE TABLE tool_calls_v9 (
    ...
    tool_kind INTEGER NOT NULL CHECK (tool_kind BETWEEN 1 AND 7),
...
CREATE TABLE tool_audit_facts_v9 (
    ...
    tool_kind INTEGER CHECK (tool_kind IS NULL OR tool_kind BETWEEN 1 AND 7),
...
INSERT INTO tool_audit_facts_v9 SELECT * FROM tool_audit_facts;
DROP TABLE tool_audit_facts;
ALTER TABLE tool_audit_facts_v9 RENAME TO tool_audit_facts;

...
CREATE TABLE tool_calls_v12 (
    ...
    tool_kind INTEGER NOT NULL CHECK (tool_kind BETWEEN 1 AND 10),
...
CREATE TABLE tool_audit_facts_v12 (
    ...
    tool_kind INTEGER CHECK (tool_kind IS NULL OR tool_kind BETWEEN 1 AND 10),
...
INSERT INTO tool_audit_facts_v12 SELECT * FROM tool_audit_facts;
DROP TABLE tool_audit_facts;
ALTER TABLE tool_audit_facts_v12 RENAME TO tool_audit_facts;
